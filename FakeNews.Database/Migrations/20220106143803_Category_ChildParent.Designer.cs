...
namespace FakeNews.Database.Migrations
{
    ...
    [Migration("20220106143803_Category_ChildParent")]
    partial class Category_ChildParent
    {
            ...
            modelBuilder.Entity("FakeNews.Database.Tables.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2022, 1, 6, 17, 26, 0, 0, DateTimeKind.Unspecified),
                            CreatorId = 1,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("FakeNews.Database.Tables.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            NewsId = 1,
                            PublicId = new Guid("46c6acf8-43a5-447d-8ed5-dc42f80b9033"),
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            NewsId = 1,
                            PublicId = new Guid("a633c058-0949-4167-92fd-8dc88fa1abe9"),
                            SenderMail = "m.hamzeh@yahoo.com",
                            SenderName = "محمدمهدی حمزه",
                            Status = 1,
                            Text = "کامنت دوم"
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            NewsId = 1,
                            PublicId = new Guid("157acd1e-7bce-4be8-a988-87163647b06d"),
                            SenderMail = "m.hamzeh@yahoo.com",
                            SenderName = "محمدمهدی حمزه",
                            Status = 1,
                            Text = "کامنت سوم"
            ...
            modelBuilder.Entity("FakeNews.Database.Tables.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "39c69819-3f8b-4696-bcc2-69983b8905d3",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatorId = 1,
                            IsDeleted = false,
                            Name = "Admin",
                            NormalizedName = "Admin",
                            PublicId = new Guid("1e60f7c9-9825-4a82-b2a8-6d861864787d")
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "7ee12e77-cfd3-45d5-91fc-31307d1d8ff8",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatorId = 1,
                            IsDeleted = false,
                            Name = "User",
...
<p>هر چند که سامسونگ هنوز هیچ صحبتی از سری Galaxy S22 به میان نیاورده اما شایعات به رونمایی احتمالی در تاریخ 8 فوریه (19 بهمن) 2022 در رویداد Galaxy Unpacked اشاره دارند در حالی که 10 روز پس از آن عرضه رسمی اتفاق می‌افتد. البته پیش فروش این سری پس از مراسم مذکور شروع خواهد شد.</p>
                            ...
                            PublicId = new Guid("e2955ef9-9b01-4d1d-ba67-5c88cfa9dc21"),
                            PublishDate = new DateTime(2021, 7, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SeenCount = 1,
...
<p></p>
                            ...
                            PublicId = new Guid("e2955ef9-9b01-4d1d-ba67-5c88cfa9dc21"),
                            PublishDate = new DateTime(2021, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SeenCount = 1,
